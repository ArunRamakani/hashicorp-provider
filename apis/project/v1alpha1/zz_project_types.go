...
type ProjectParameters struct {
	...
	// A boolean to state if the project is private or not.
	// +kubebuilder:validation:Optional
	...
	// The slug or UUID (including the enclosing `{}`) of the workspace the project belongs to.
	// +kubebuilder:validation:Required
...
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,bitbucketjet}
type Project struct {
